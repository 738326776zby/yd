            ...
            <>
              ...
              >
                <a
                  ...
                  href={`/app/${(customCollection as WorkflowToolProviderResponse)
                      .workflow_app_id
                    }/workflow`}
                  rel="noreferrer"
                  target="_blank"
                >
                  <div className="leading-5 text-sm font-medium">
      ...
      <div className="pt-3">
        ...
        {!isDetailLoading && (
          <div className="text-xs font-medium leading-6 text-gray-500">
            ...
            {collection.type !== CollectionType.workflow && (
              <div className="text-[14px] font-semibold text-[#495464] mb-4">
                插件工具
              </div>
            )}
          ...
          <div className="mt-1">
            ...
            {collection.type === CollectionType.workflow &&
              (
                ...
                <div
                  key={item.name}
                  className="mb-2 px-4 py-3 rounded-xl bg-gray-25 border-[0.5px] border-gray-200"
                >
                  <div className="flex items-center gap-2">
