...
import AbilityExploreNav from './ability-explore-nav'
import ToolsNav from './tools-nav'
import GithubStar from './github-star'
import EvaluationsNav from './evaluation'
    ...
    <div className='flex flex-1 items-center justify-between px-4 bg-background-body'>
      ...
      {!isMobile && (
        <div className='flex items-center'>
          ...
          {!isCurrentWorkspaceDatasetOperator && <EvaluationsNav className={navClassName} />}
        </div>
      )}
